//please make this a class dear god
class ditherWorker { 
  ...
  private floydSteinberg(i, nData, error, limX) {
  ...
  private JJN(i, nData, error, limX) {
  ...
  private atkinson(i, nData, error, limX) 
  {
  ...
  private errorSpread(pixel, error, errorQuoeficient, quantaSize) {
  ...
  private drawImage() { //draws the image on the canvas
...
//     function this.errorSpread(pixel, error, errorQuoeficient, quantaSize) {
